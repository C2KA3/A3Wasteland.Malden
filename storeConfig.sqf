...
[
	...
	["CAR-95-1 LMG (Hex)", "arifle_CTARS_hex_F", 4500],
 	["CAR-95-1 LMG (G Hex)", "arifle_CTARS_ghex_F", 4500],
...
[
	...
	["7.62mm 150Rnd Box", "150Rnd_762x54_Box", 225],
	["7.62mm 150Rnd Tracer (Green) Box", "150Rnd_762x54_Box_Tracer", 225],
	[".338 LM 10Rnd Mag", "10Rnd_338_Mag", 350],
	[".338 NM 130Rnd Belt", "130Rnd_338_Mag", 350],
	["9.3mm 10Rnd Mag", "10Rnd_93x64_DMR_05_Mag", 450],
	["9.3mm 150Rnd Belt", "150Rnd_93x64_Mag", 450],
	...
	["40mm Smoke Round (Red)", "1Rnd_SmokeRed_Grenade_shell", 15000],
	...
	["40mm 3Rnd Smokes (Red)", "3Rnd_SmokeRed_Grenade_shell", 15000],
...
[
	...
	["F/A-181 Black Wasp (Gun-Only)", "B_Plane_Fighter_01_Stealth_F", 700000, "vehicle"], // no missiles or bombs
	...
	["K40 Ababil-3 Missile UAV", "I_UAV_02_dynamicLoadout_F", 550000, "vehicle", "variant_greyhawkMissile"],

	["MQ4A Greyhawk Bomber UAV", "B_UAV_02_dynamicLoadout_F", 450000, "vehicle", "variant_greyhawkBomber"], // Bomber UAVs are a lot harder to use, hence why they are cheaper than Missile ones
	["K40 Ababil-3 Bomber UAV", "O_UAV_02_dynamicLoadout_F", 450000, "vehicle", "variant_greyhawkBomber"],
	["K40 Ababil-3 Bomber UAV", "I_UAV_02_dynamicLoadout_F", 450000, "vehicle", "variant_greyhawkBomber"],
...
[	
	...
	["Rescue Boat", "C_Rubberboat", 1000, "boat", "SKIPSAVE"],
	["Rescue Boat (NATO)", "B_Lifeboat", 1000, "boat", "SKIPSAVE"],
	["Rescue Boat (CSAT)", "O_Lifeboat", 1000, "boat", "SKIPSAVE"],
	["Assault Boat (NATO)", "B_Boat_Transport_01_F", 1000, "boat", "SKIPSAVE"],
	["Assault Boat (CSAT)", "O_Boat_Transport_01_F", 1000, "boat", "SKIPSAVE"],
	["Assault Boat (AAF)", "I_Boat_Transport_01_F", 1000, "boat", "SKIPSAVE"],
	["Assault Boat (FIA)", "B_G_Boat_Transport_01_F", 1000, "boat", "SKIPSAVE"],
	...
	["RHIB", "I_C_Boat_Transport_02_F", 50000, "boat"],
...
[
	...
	["LSD", "lsd", localize "STR_WL_ShopDescriptions_LSD", "client\icons\lsd.paa", 25000, 15000],
	["Marijuana", "marijuana", localize "STR_WL_ShopDescriptions_Marijuana", "client\icons\marijuana.paa", 25000, 15000],
	["Cocaine", "cocaine", localize "STR_WL_ShopDescriptions_Cocaine", "client\icons\cocaine.paa", 25000, 15000],
	["Heroin", "heroin", localize "STR_WL_ShopDescriptions_Heroin", "client\icons\heroin.paa", 25000, 15000]
];
