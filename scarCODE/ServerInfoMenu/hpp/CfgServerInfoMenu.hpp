class CfgServerInfoMenu
{
   ...
   serverName = "C2K Wasteland Malden";
   class menuItems
   {
      ...
      class second
      {
         ...
         content[] = {
            "<br/>• Small Money Shipment: $50,000<br />• Medium Money Shipment: $100,000<br />• Large Money Shipment: $150,000<br />• Heavy Money Shipment: $200,000<br />• TownInvasion: $85,000<br />• Sunken Treasure: $100,000<br />• Roadblock: $30,000<br /></p>"
         };
      };
      class third
      {
      ...
      class seventh
      {
         ...
         title = "GitHub do C2K";
         content[] = {
            "GitHub: <t color='#0091CD'><a href='https://github.com/C2KA3/A3Wasteland.Malden'>github.com/bondrj/A3Wasteland.Malden<br/></a></t>"
         };
      };
   };
};
